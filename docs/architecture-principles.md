...
| Public Core with separate self-hosted/hosted shells | Accepted | Project references and restricted exports create one Core package; separate operator/display processes and exact verified GitHub Release artifacts keep the hosted consumer below Core's unauthenticated HTTP boundary (ADR-0026). |
