...
- Review statement: The phase, capabilities, workstreams, limits, repository-backed application deployment claim, completed M-18 retirement record, documentation automation, and isolated-worktree guidance were reviewed together against origin/main commit 0f8f65f. The Core operator-panel and exploratory hosted-service roadmap, proposed ADR-0026, and 49-task gated work breakdown are now incorporated as an active architecture-planning workstream; implementation has not begun. Landing-page and synthetic-display worktrees remain separately owned, and no new live application, provider, route, or service probe was performed.
...
- Advance the Core operator panel through its A01-A08 architecture gate before package restructuring or UI implementation.
...
| `guided-setup` | Guided non-secret installation configuration | `planned` | Provide a private-by-default Core operator panel for versioned configuration, guided sources, readiness, and planned-display review while retaining strict generated runtime contracts. | [`docs/configuration.md`](configuration.md), [`docs/future-parity-roadmap.md`](future-parity-roadmap.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/decisions/0026-public-core-and-hosted-shell.md`](decisions/0026-public-core-and-hosted-shell.md) |
...
- Present state: The M-18-aware roadmap now includes the Core operator-panel concept, the exploratory commercial hosted-service concept, proposed ADR-0026, and a 49-task dependency-ordered work breakdown. The Core panel remains planned: no package restructuring, operator route, provider enrollment, hosted repository, billing integration, or deployment has begun.
- Capabilities: `guided-setup`, `preview-and-controls`, `durable-state`, `fixture-evaluation`
- Next: Execute A01 to freeze feature ownership, MVP exclusions, and observable acceptance criteria. Complete A02 through A08 in dependency order, and do not begin Phase B until the architecture-ready gate is satisfied.
- Documentation: [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/project-state.md`](project-state.md)
...
- What exact feature ownership, MVP exclusions, and acceptance evidence A01 should freeze for the Core operator panel and hosted shell.
<!-- prettier-ignore-end -->
