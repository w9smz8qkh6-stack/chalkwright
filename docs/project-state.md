...
- Implementation files covered: 521
- Implementation fingerprint: `4129dda751d6446c03bcf25eefb923b6577fa1946891cfcdbb3faa86cdc0641e`
- Semantic review: **CURRENT**
- Review statement: The phase, capabilities, workstreams, limits, repository-backed application deployment claim, completed M-18 retirement record, documentation automation, and isolated-worktree guidance were reviewed together against origin/main commit 0f8f65f, the completed A04 contract commit 1ca7d5c, and the A05 acceptance correction following commit 0fbc5e2. The Core operator-panel and exploratory hosted-service roadmap now include completed A01 feature ownership, A02 threat modeling, accepted A03 boundary decisions, A04's versioned workspace and actor vocabulary, and A05's adapter-neutral configuration lifecycle, persistence, export/backup, migration, rollback, protected-reference, and bounded audit contracts. A05 exact-workspace admission now compares workspace kind and ID plus installation or organization identity, and newly returned immutable/checksummed snapshots detach canonical JSON data from caller-owned objects; focused compile-time and runtime evidence covers same-ID tenant substitution and post-construction mutation. The panel runtime, persistence adapters, and package restructuring have not begun; A06-A08 remain required for the architecture-ready gate. Landing-page and synthetic-display worktrees remain separately owned, and no new live application, provider, route, or service probe was performed.
...
- Advance the Core operator panel through its remaining A06-A08 architecture gate before package restructuring or UI implementation.
...
| `guided-setup` | Guided non-secret installation configuration | `planned` | Provide a private-by-default Core operator panel for versioned configuration, guided sources, readiness, and planned-display review while retaining strict generated runtime contracts. A04 established the shared workspace and actor vocabulary; A05 now establishes immutable detached drafts and revisions, validation eligibility, activation, supersession, rollback, exact full-workspace previews, portable configuration, protected references, bounded audit metadata, and adapter-neutral recovery contracts. The panel itself remains planned. | [`docs/configuration.md`](configuration.md), [`docs/core-and-hosted-feature-acceptance-matrix.md`](core-and-hosted-feature-acceptance-matrix.md), [`docs/core-and-hosted-threat-model.md`](core-and-hosted-threat-model.md), [`docs/core-workspace-actor-contracts.md`](core-workspace-actor-contracts.md), [`docs/core-configuration-state-contracts.md`](core-configuration-state-contracts.md), [`docs/future-parity-roadmap.md`](future-parity-roadmap.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/decisions/0026-public-core-and-hosted-shell.md`](decisions/0026-public-core-and-hosted-shell.md) |
...
- Present state: A01 through A05 are complete. The authoritative feature acceptance matrix freezes product ownership; the threat model defines 32 stable threats, security invariants, residual-risk dispositions, and 18 negative-test families; accepted ADR-0026 fixes the package, artifact, process, compatibility, and presentation seam; A04 defines the versioned workspace and actor vocabulary; and A05 defines immutable detached configuration drafts and revisions, explicit eligibility/activation/supersession/rollback, exact optimistic concurrency, non-mutating full-workspace previews, portable redacted exports, protected backup manifests, forward-only full-workspace checksummed migrations, exact 0.x release pairing, rollback admission, protected verifier references, and bounded audit metadata. Focused compile-time and runtime tests cover self-hosted and hosted fixtures, stale writes, last-known-good preservation, malformed values, same-ID/different-organization or installation and cross-kind substitution, post-construction mutation aliases, cross-workspace artifacts, tampering, atomic migration failure, and rollback selection. These contracts are not yet threaded into use cases or adapters, and current SQLite schemas remain unchanged. The M-18-aware roadmap and 49-task dependency-ordered work breakdown remain governing. No package restructuring, operator/display process, artifact, operator route, provider enrollment, hosted repository, billing integration, or deployment has begun.
- Capabilities: `guided-setup`, `preview-and-controls`, `durable-state`, `fixture-evaluation`
- Next: Execute A06 to fix the exact first-release source modes, formats, provenance, freshness, and provider-necessity boundaries. Complete A07 and A08 in dependency order, and do not begin Phase B until the architecture-ready gate is satisfied.
- Documentation: [`docs/core-and-hosted-feature-acceptance-matrix.md`](core-and-hosted-feature-acceptance-matrix.md), [`docs/core-and-hosted-threat-model.md`](core-and-hosted-threat-model.md), [`docs/core-workspace-actor-contracts.md`](core-workspace-actor-contracts.md), [`docs/core-configuration-state-contracts.md`](core-configuration-state-contracts.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/project-state.md`](project-state.md)
...
- The current strict runtime configuration is not yet the intended guided end-user setup experience. A04 and A05 define the versioned workspace/actor and configuration-state contract surfaces, but no persistence adapter or use case implements those contracts yet and current SQLite schemas and runtime behavior are unchanged.
...
- Which exact first-release source modes, formats, provenance, freshness rules, and provider-necessity exceptions A06 should establish without embedding provider adapter details in the portable configuration contract.
<!-- prettier-ignore-end -->
