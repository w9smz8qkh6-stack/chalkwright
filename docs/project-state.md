...
- Deliver dispatched B01 dependency-direction enforcement through its isolated worktree; C05 and C06 remain independently ready but unassigned.
...
- Which independently ready Core follow-on item—B01, C05, or C06—should be dispatched next under the WBS dependencies and isolated-worktree ownership rules.
