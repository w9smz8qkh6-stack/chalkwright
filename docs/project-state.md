...
- The A06 shared-resource CIDR policy is a reviewed conservative snapshot, not a dynamic future-registry claim; it must be reviewed again before shared-resource implementation and whenever a referenced IANA IPv4/IPv6 registry updates.
