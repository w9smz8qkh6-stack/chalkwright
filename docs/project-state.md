...
- Implementation files covered: 515
- Implementation fingerprint: `548c35ca42c34b3507b9a4a863e70a9986792f5f2dc2d533211200e5a2162b31`
- Semantic review: **CURRENT**
- Review statement: The phase, capabilities, workstreams, limits, repository-backed application deployment claim, completed M-18 retirement record, documentation automation, and isolated-worktree guidance were reviewed together against origin/main commit 0f8f65f. The Core operator-panel and exploratory hosted-service roadmap now include completed A01 feature ownership, A02 threat modeling, accepted A03 boundary decisions, and A04's versioned workspace, actor, independent-authority, request-context, target, and bounded audit contracts with focused compile-time and runtime evidence. The panel runtime and package restructuring have not begun; A05-A08 remain required for the architecture-ready gate. Landing-page and synthetic-display worktrees remain separately owned, and no new live application, provider, route, or service probe was performed.
...
- Advance the Core operator panel through its remaining A05-A08 architecture gate before package restructuring or UI implementation.
...
| `guided-setup` | Guided non-secret installation configuration | `planned` | Provide a private-by-default Core operator panel for versioned configuration, guided sources, readiness, and planned-display review while retaining strict generated runtime contracts. A04 has established the shared versioned workspace, actor, target, authority, request-context, and bounded audit-scope boundary; the panel itself remains planned. | [`docs/configuration.md`](configuration.md), [`docs/core-and-hosted-feature-acceptance-matrix.md`](core-and-hosted-feature-acceptance-matrix.md), [`docs/core-and-hosted-threat-model.md`](core-and-hosted-threat-model.md), [`docs/core-workspace-actor-contracts.md`](core-workspace-actor-contracts.md), [`docs/future-parity-roadmap.md`](future-parity-roadmap.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/decisions/0026-public-core-and-hosted-shell.md`](decisions/0026-public-core-and-hosted-shell.md) |
...
- Present state: A01 through A04 are complete. The authoritative feature acceptance matrix freezes product ownership; the threat model defines 32 stable threats, security invariants, residual-risk dispositions, and 18 negative-test families; accepted ADR-0026 fixes the package, artifact, process, compatibility, and presentation seam; and the versioned A04 TypeScript contracts now distinguish self-hosted installation and hosted organization workspaces, nominal workspace-bound targets, actor attribution, six independent authorities, exact shell request contexts, and bounded audit scope. Focused compile-time and runtime tests fail closed on missing, extra, malformed, non-JSON-safe, and cross-scope values. These types are not yet threaded into current use cases. The M-18-aware roadmap and 49-task dependency-ordered work breakdown remain governing. No package restructuring, operator/display process, artifact, operator route, provider enrollment, hosted repository, billing integration, or deployment has begun.
- Capabilities: `guided-setup`, `preview-and-controls`, `durable-state`, `fixture-evaluation`
- Next: Execute A05 to define configuration, persistence, migration, revision, concurrency, backup/export, and audit-event schemas across SQLite and hosted persistence ports. Complete A06 through A08 in dependency order, and do not begin Phase B until the architecture-ready gate is satisfied.
- Documentation: [`docs/core-and-hosted-feature-acceptance-matrix.md`](core-and-hosted-feature-acceptance-matrix.md), [`docs/core-and-hosted-threat-model.md`](core-and-hosted-threat-model.md), [`docs/core-workspace-actor-contracts.md`](core-workspace-actor-contracts.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/project-state.md`](project-state.md)
...
- The current strict configuration schemas are not yet the intended guided end-user setup experience. A04 has defined the versioned Core workspace/actor contract surface, but it is not yet threaded into use cases and has not changed runtime behavior.
...
- Which configuration, persistence, migration, revision, concurrency, backup/export, and audit-event schemas A05 should establish across SQLite and hosted persistence ports.
<!-- prettier-ignore-end -->
