...
- Select the next dependency-ready Core item through the WBS ledger after accepted C12 presentation profiles; B01, C05, and C06 are ready but unassigned.
