...
- Implementation files covered: 564
- Implementation fingerprint: `b400c549b6cb4f0b4d8ee3e1f2a0aaf0799d65109555f2debca78079e975eea2`
- Semantic review: **CURRENT**
- Review statement: The phase, capabilities, workstreams, limits, repository-backed deployment claim, M-18 retirement record, completed A01-A08 architecture work, C01 configuration services, C02 operator shell, and C03 display controls were reviewed together against the A02 threat model, accepted ADR-0026, A05 lifecycle, A07 information architecture, exact A08 fixture suite, focused C01-C03 tests, browser evidence, and governing documentation in this worktree. C03 projects timezone, rooms, screens, HTTPS display references, class-code readiness, and ordinary no-JavaScript controls through the explicit-loopback C02 shell. Display drafts preserve the active revision. Generated codes are returned once; protected state stores only scrypt-v1 verifiers, viewer records store token digests, and bounded uniform admission failures retain no attempted values. Rotation and revocation atomically clear earlier viewer sessions while operator reachability remains available. The exact A08 C03 projection, same-origin action guards, display/operator route separation, and accepted viewport/accessibility envelope pass. The executable remains synthetic and in-memory, with no public viewer route, durable production adapter, provider integration, account/authentication, billing, commercial framework decision, package hardening, deployment, or live effect. C04 is next; Phase B and D00 remain gated behind C10. Landing-page and synthetic-display worktrees remain separately owned, and no live application, provider, credential, route, or classroom-display probe was performed.
...
- Continue with C04 against the completed C03 display controls; keep C09 and C10 in the authoritative operator-first sequence.
...
| `guided-setup` | Guided non-secret installation configuration | `planned` | Provide a private-by-default Core operator panel for versioned configuration, guided sources, readiness, and planned-display review while retaining strict generated runtime contracts. A04-A08 established scope and acceptance contracts; C01 implements versioned configuration; C02 implements the separate explicit-loopback seven-page shell; and C03 implements timezone, room/screen draft, HTTPS display-reference, slowly hashed class-code, screen-scoped viewer-session, and readiness controls through that shell. Source forms, planned-display integration, durable production storage/composition, public viewer admission, and OAuth clients remain planned. | [`docs/configuration.md`](configuration.md), [`docs/core-and-hosted-feature-acceptance-matrix.md`](core-and-hosted-feature-acceptance-matrix.md), [`docs/core-and-hosted-threat-model.md`](core-and-hosted-threat-model.md), [`docs/core-workspace-actor-contracts.md`](core-workspace-actor-contracts.md), [`docs/core-configuration-state-contracts.md`](core-configuration-state-contracts.md), [`docs/core-source-mode-contracts.md`](core-source-mode-contracts.md), [`docs/core-operator-panel-information-architecture.md`](core-operator-panel-information-architecture.md), [`docs/core-operator-shell.md`](core-operator-shell.md), [`docs/core-display-configuration.md`](core-display-configuration.md), [`docs/core-goal1-fixture-contract-suite.md`](core-goal1-fixture-contract-suite.md), [`docs/future-parity-roadmap.md`](future-parity-roadmap.md), [`docs/core-and-hosted-implementation-work-breakdown.md`](core-and-hosted-implementation-work-breakdown.md), [`docs/decisions/0026-public-core-and-hosted-shell.md`](decisions/0026-public-core-and-hosted-shell.md) |
...
- Present state: A01 through A08 and C01-C03 are complete in this worktree. C01 provides versioned configuration and last-known-good semantics; C02 provides the guarded explicit-loopback no-login shell; and C03 adds timezone, room/screen draft, HTTPS display-reference, class-code, viewer-session, and readiness controls. Generated 128-bit codes are returned once and persist only as scrypt-v1 verifiers; viewer tokens persist only as digests; failures are uniform and bounded; and rotate/revoke clears earlier sessions atomically without affecting operator access. The exact A08 C03 projection, draft continuity, same-origin form guards, C02 ingress negatives, and accepted browser envelope pass. The executable remains synthetic/in-memory, with no source parser/fetcher, OAuth client, durable production schema/adapter, installed service, public viewer route, provider enrollment, account flow, hosted repository, billing integration, commercial framework selection, package hardening, deployment, or live effect.
- Capabilities: `guided-setup`, `preview-and-controls`, `durable-state`, `fixture-evaluation`
- Next: Execute C04 through the completed private shell by adding the closed first-goal manual source registry and forms. Continue the operator-first lane through C09 and C10; do not begin Phase B or D00 before C10 is accepted.
...
- The current strict runtime configuration is not yet the complete guided end-user setup experience. C01 implements reusable configuration lifecycle use cases; C02 supplies the explicit-loopback shell; and C03 adds synthetic in-memory display draft, room/screen, timezone, display-reference, class-code, and viewer-session controls. No source parser/fetcher, OAuth client, durable production persistence adapter, installed service, public viewer route, production route, or live effect was added; current SQLite schemas and production runtime behavior are unchanged.
...
- How C04 should add the closed first-goal manual source registry and forms without implementing uploads, shared-resource acquisition, or connected accounts early.
<!-- prettier-ignore-end -->
