...
.presentation-preview{margin-top:1rem;padding:1rem;border:1px solid var(--line);border-radius:.75rem;background:linear-gradient(135deg,rgb(12 74 110 / 65%),rgb(30 41 59 / 86%));transition:background 900ms ease,transform 900ms ease}.presentation-preview.theme-daylight{color:#172033;background:linear-gradient(135deg,#dbeafe,#f8fafc)}.presentation-preview.transition-snappy{transition-duration:160ms}.presentation-preview.transition-none{transition:none}.presentation-preview .preview-title{margin:0;font-size:1.2rem}.presentation-preview .preview-copy{margin:.45rem 0 0;line-height:1.5}.presentation-preview[data-reduced-motion="always"]{transition:none}
`;
